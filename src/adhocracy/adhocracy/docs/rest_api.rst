...
structures and available interfaces with resource data::
    ...
    ['adhocracy.sheets.interfaces.IName', 'adhocracy.sheets.interfaces.IPool']
...
The value for POST gives us list with valid request data stubs::
    ...
    ...                   'data': {'adhocracy.sheets.interfaces.IName': {}}}
...
Returns resource and child elements meta data and all propertysheet interfaces with data::
    ...
    {'adhocracy.sheets.interfaces.IName': {'name': ''},
     'adhocracy.sheets.interfaces.IPool': {'elements': []}}
...
Modify data of an existing resource ::
    ...
    ...         'data': {'adhocracy.sheets.interfaces.IName': {'name': 'proposals'}}}
...
Check the changed resource ::
    ...
    >>> resp_data["data"]["adhocracy.sheets.interfaces.IName"]["name"]
    'proposals'
...
If you submit invalid data the return error code is 400::
    ...
    >>> data = {'content_type': 'adhocracy.resources.interfaces.IPool',
    ...         'data': {'adhocracy.sheets.interfaces.WRONGINTERFACE': {'name': 'Proposals'}}}
...
If we create a second Section version ::
    ...
    ...         'data': {
    ...              'adhocracy.sheets.interfaces.ISection': {
...
FIXME: postroot will go away.
    ...
    ...                       'data': { 'adhocracy.sheets.interfaces.Text': {
...
requests!)
    ...
    >>> propv2["data"]["adhocracy.sheets.interfaces.IDocument"]["paragraphs"]
    ...
    ... propv2_vrsbl = propv2["data"]["adhocracy.sheets.interfaces.IVersionable"]
