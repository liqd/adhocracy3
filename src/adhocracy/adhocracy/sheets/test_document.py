...
class TestDocumentSheet:
    ...
    def test_create(self, meta, context):
        ...
        from adhocracy.sheets.document import DocumentSchema
    ...
    def test_get_empty(self, meta, context):
        inst = meta.sheet_class(meta, context)
        assert inst.get() == {'title': '', 'description': '', 'elements': []}


def test_includeme_register_document_sheet(config):
    from adhocracy.sheets.document import IDocument
    from adhocracy.utils import get_sheet
    config.include('adhocracy.sheets.document')
...
class TestParagraphSheet:
    ...
    def test_create(self, meta, context):
        from adhocracy.sheets.document import IParagraph
        from adhocracy.sheets.document import ParagraphSchema
        from adhocracy.sheets import GenericResourceSheet
        inst = meta.sheet_class(meta, context)
        assert isinstance(inst, GenericResourceSheet)
...
class TestSectionSheet:
    ...
    def test_create(self, meta, context):
        ...
        from adhocracy.sheets.document import SectionSchema
        from adhocracy.sheets import GenericResourceSheet
        inst = meta.sheet_class(meta, context)
        assert isinstance(inst, GenericResourceSheet)
