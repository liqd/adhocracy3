...
def test_resourcefactory_valid_assign_ifaces():
...
def test_resourcerfactory_none_valid_wrong_iresource_iface():
    from adhocracy.resources import ResourceFactory
...
def test_resourcefactory_none_valid_wrong_iproperty_iface():
    from adhocracy.resources import ResourceFactory
    from adhocracy.resources.interfaces import IResource
...
def test_includeme_registry_register_factories(config):
    ...
    assert 'adhocracy.resources.interfaces.IVersionableFubel' in content_types
    assert 'adhocracy.resources.interfaces.IFubelVersionsPool' in content_types
...
def test_includeme_registry_create_content(config):
    ...
    resource = config.registry.content.create(iresource_id)
