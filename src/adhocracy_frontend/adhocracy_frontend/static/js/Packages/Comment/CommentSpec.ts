...
export var register = () => {
    describe("Comment", () => {
        ...
        beforeEach(() => {
            ...
            adapterMock = jasmine.createSpyObj("adapterMock", ["create", "createItem", "content", "edited", "refersTo", "creator",
            ...
            adhHttpMock = jasmine.createSpyObj("adhHttpMock", ["postToPool", "resolve", "postNewVersion", "getNewestVersionPathNoFork",
                "get"]);
