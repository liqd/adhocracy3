...
var MercatorProposalDetailPage = function() {
    this.column = element.all(by.tagName("adh-mercator-2015-proposal-detail-column")).first();
    ...
    this.rateWidget = element(by.css(".mercator-proposal-detail-view .meta-list-item-rate"));
    this.rateDifference = this.rateWidget.element(by.css(".like-difference"));
    this.detailContainer = element(by.css("adh-mercator-2015-proposal-detail-view .section-jump-body"));
    ...
    this.title = element(by.css("adh-mercator-2015-proposal-detail-view .section-jump-cover-header"));
