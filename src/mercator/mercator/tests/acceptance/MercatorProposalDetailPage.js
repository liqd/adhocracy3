...
var MercatorProposalDetailPage = function() {
    this.column = element.all(by.tagName("adh-mercator-proposal-detail-column")).first();
    ...
    this.rateWidget = element(by.css(".mercator-proposal-detail-view .mercator-proposal-detail-meta-item-rate"));
    this.rateDifference = this.rateWidget.element(by.css(".like-difference"));
    this.detailContainer = element(by.css("adh-mercator-proposal-detail-view .section-jump-body"));
    ...
    this.title = element(by.css("adh-mercator-proposal-detail-view .section-jump-cover-header"));
