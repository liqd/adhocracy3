...
root_acm = ACM().deserialize(
    {'principals':                                   ['anonymous', 'participant', 'moderator',  'creator', 'initiator', 'admin', 'god'],  # noqa
     'permissions': [  # general
                     ['view',                          Allow,       Allow,         Allow,        Allow,     Allow,       Allow,   Allow],  # noqa
                     ['create',                        None,        Allow,         Allow,        None,      Allow,       Allow,   Allow],  # noqa
                     ['edit',                          None,        None,          None,         Allow,     None,        Allow,   Allow],  # noqa
                     ['edit_some',                     None,        Allow,         Allow,        Allow,     Allow,       Allow,   Allow],  # noqa
                     ['delete',                        None,        None,          Allow,        Allow,     None,        Allow,   Allow],  # noqa
                     ['hide',                          None,        None,          Allow,        None,      Allow,       Allow,   Allow],  # noqa
                     ['do_transition',                 None,        None,          None,         None,      Allow,       Allow,   Allow],  # noqa
                     ['message_to_user',               None,        Allow,         Allow,        None,      Allow,       Allow,   Allow],  # noqa
                     # structure resources
                     ['create_pool',                   None,        None,          None,         None,      None,        Allow,   Allow],  # noqa
                     ['create_organisation',           None,        None,          None,         None,      None,        Allow,   Allow],  # noqa
                     ['create_process',                None,        None,          None,         None,      Allow,       Allow,   Allow],  # noqa
                     # simple content resources
                     ['create_asset',                  None,        Allow,         None,         None,      None,        None,    Allow],  # noqa
                     ['create_external',               None,        Allow,         None,         None,      None,        None,    Allow],  # noqa
                     # versioned content resources
                     ['create_proposal',               None,        Allow,         None,         None,      None,        None,    Allow],  # noqa
                     ['edit_proposal',                 None,        None,          None,         Allow,     None,        None,    Allow],  # noqa
                     ['create_comment',                None,        Allow,         Allow,        None,      None,        None,    Allow],  # noqa
                     ...
                     ['create_user',                   Allow,       None,          None,         None,      None,        Allow,   Allow],  # noqa
                     ['create_sheet_password',         Allow,       None,          None,         None,      None,        Allow,   Allow],  # noqa
                     ['create_sheet_userbasic',        Allow,       None,          None,         None,      None,        Allow,   Allow],  # noqa
