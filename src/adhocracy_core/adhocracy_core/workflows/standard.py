...
standard_meta = freeze({
    ...
    'states': {
        'draft': {'title': 'Draft',
                  ...
                  'acm': {'principals':         ['anonymous',   'moderator',   'participant', 'creator', 'initiator', 'admin'],
                          'permissions':
                          [['view',              'Deny',        'Allow',       'Deny',        'Allow',   'Allow',     'Allow'],
                           ['create_document',    None,         'Allow',        None,          None,      None,        None],
                           ['edit_document',      None,         'Allow',        None,         'Allow',   'Allow',      None],
                          ]},
                        ...
                        'acm': {'principals':                    ['anonymous', 'participant', 'moderator', 'creator', 'initiator'],
                                'permissions':
                                  [['view',                        None,       'Allow',       'Allow',     'Allow',   'Allow'],
                                   ...
                                   ['create_relation',             None,       'Allow',        None,        None,      None],
                                   ['edit_relation',               None,        None,          None,       'Allow',    None]
                                  ]},
                        },
