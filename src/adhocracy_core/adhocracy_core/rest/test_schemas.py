...
class TestCreateArbitraryFilterNode:
    ...
    @mark.parametrize("index, index_value, query, wanted_schema_class",
                      [(FieldIndex(''), 1, '1', schema.Integer),
                       ...
                       (FieldIndex(''), 1.003, '1.003', schema.Float),
                       (FieldIndex(''), 1.0, 1.0, schema.Float),
                       (FieldIndex(''), 1.0003, ['eq', '1.0003'], rest_schemas.FieldComparableFloat),
                       (FieldIndex(''), 1.0, ['any', ['1.0', '2.0']], rest_schemas.FieldComparableFloats),
