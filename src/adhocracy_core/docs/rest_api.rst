...
* Item (old name: FubelVersions-Pool): base class of any versionable items,
  such as Documents, Documents, Sections etc. Contains a list of
...
* ItemVersion (old name: Versionable-Fubel): a specific version of a
  versionable item, e.g. a DocumentVersion, DocumentVersion, or
  SectionVersion.
...
(content types) defined by the system::
    ...
    >>> pprint([x for x in resp_data['resources']])
...
example, a pool can contain other pools; a document can contain tags. ::
    ...
    ['adhocracy_core.interfaces.ITag', ...'adhocracy_core.resources.document.IDocumentVersion'...]
...
* A listing of resources affected by the transaction::
  ...
  transaction::
      ...
      ['http://localhost/adhocracy/Documents/']
...
...    >>> resp_data = testapp.put_json(rest_url + "/adhocracy/Documents", data, headers=god_header).json
...    >>> pprint(resp_data)
...    {'content_type': 'adhocracy_core.resources.pool.IBasicPool',
...     'path': rest_url + '/adhocracy/Documents'}

Check the changed resource ::

...   >>> resp_data = testapp.get(rest_url + "/adhocracy/Documents").json
...
.. >>> testapp.put_json(rest_url + "/adhocracy/Documents", data, headers=god_header)
...
This document explains updates to resources with version control.  Two
...
of a title, description, and a list of references to documents.
...
stay in the example above: If we have a document with two documents,
and update a document, the post request must contain both the parent
version(s) of the document, but also the parent version(s) of the
...
Create a Document (a subclass of Item which pools DocumentVersions) ::
    ...
    ...              }
    ...         }
    >>> resp = testapp.post_json(rest_url + "/adhocracy/Documents", pdag, headers=god_header)
    >>> pdag_path = resp.json["path"]
    >>> pdag_path
    '.../adhocracy/Documents/kommunismus/'
...
The return data has the new attribute 'first_version_path' to get the path first Version::
    ...
    >>> pvrs0_path
    '.../adhocracy/Documents/kommunismus/VERSION_0000000/'
...
The Document has the IVersions and ITags interfaces to work with Versions::
    ...
    ['.../adhocracy/Documents/kommunismus/FIRST/', '.../adhocracy/Documents/kommunismus/LAST/']
...
version is automatically created along with the updated Section version::
    ...
    {'elements': ['.../adhocracy/Documents/kommunismus/VERSION_0000000/',
                  '.../adhocracy/Documents/kommunismus/VERSION_0000001/',
                  '.../adhocracy/Documents/kommunismus/VERSION_0000002/',
                  '.../adhocracy/Documents/kommunismus/VERSION_0000003/']}

    >>> resp = testapp.get(rest_url + '/adhocracy/Documents/kommunismus/VERSION_0000003')
...
a new version is automatically created only for pvrs3, not for pvrs2::
    ...
    {'elements': ['.../adhocracy/Documents/kommunismus/VERSION_0000000/',
                  ...
                  '.../adhocracy/Documents/kommunismus/VERSION_0000002/',
                  '.../adhocracy/Documents/kommunismus/VERSION_0000003/',
                  '.../adhocracy/Documents/kommunismus/VERSION_0000004/']}

    >>> resp = testapp.get(rest_url + '/adhocracy/Documents/kommunismus/VERSION_0000004')
    >>> pvrs4_path = resp.json['path']
    >>> resp = testapp.get(rest_url + '/adhocracy/Documents/kommunismus/VERSION_0000002')
...
Each Versionable has a FIRST tag that points to the initial version::
    ...
    >>> resp = testapp.get(rest_url + '/adhocracy/Documents/kommunismus/FIRST')
    >>> pprint(resp.json)
    {'content_type': 'adhocracy_core.interfaces.ITag',
     'data': {...
              'adhocracy_core.sheets.name.IName': {'name': 'FIRST'},
              'adhocracy_core.sheets.tags.ITag': {'elements': ['.../adhocracy/Documents/kommunismus/VERSION_0000000/']}},
     'path': '.../adhocracy/Documents/kommunismus/FIRST/'}

It also has a LAST tag that points to the newest versions -- any versions
that aren't 'followed_by' any later version::

    >>> resp = testapp.get(rest_url + '/adhocracy/Documents/kommunismus/LAST')
    >>> pprint(resp.json)
    {'content_type': 'adhocracy_core.interfaces.ITag',
     'data': {...
              'adhocracy_core.sheets.name.IName': {'name': 'LAST'},
              'adhocracy_core.sheets.tags.ITag': {'elements': ['.../adhocracy/Documents/kommunismus/VERSION_0000004/']}},
     'path': '.../adhocracy/Documents/kommunismus/LAST/'}
...
for more on comments and *post pools*)::
    ...
    >>> resp = testapp.get('/adhocracy/Documents/kommunismus/VERSION_0000004')
    ...
    >>> first_commvers_path
    '.../adhocracy/Documents/kommunismus/comments/comment_000.../VERSION_0000000/'
...
version as predecessor::
    ...
    >>> snd_commvers_path
    '.../adhocracy/Documents/kommunismus/comments/comment_000.../VERSION_0000001/'
...
We can post comments to this pool only::
    ...
    >>> comment_path = resp.json["path"]
    >>> comment_path
    '.../adhocracy/Documents/kommunismus/comments/comment_000...'
    >>> first_commvers_path = resp.json['first_version_path']
    >>> first_commvers_path
    '.../adhocracy/Documents/kommunismus/comments/comment_000.../VERSION_0000000/'
...
resource and then post a `IRateVersion` resource below it::
    ...
    >>> snd_ratevers_path
    '...adhocracy/Documents/kommunismus/rates/rate_0000000/VERSION_0000001/'
...
omitted or left empty. ::
    ...
    ...     'method': 'POST',
    ...     'path': rest_url + '/adhocracy/Document/kommunismus',
...
requests (only GET etc.), all of its sub-entries will be empty. ::
    ...
    >>> 'http://localhost/adhocracy/Documents/' in updated_resources['changed_descendants']
    True
    >>> 'http://localhost/adhocracy/Documents/kommunismus/par1/VERSION_0000001/' in updated_resources['created']
    True
...
The LAST tag should point to the version we created within the batch request::
    ...
    >>> resp_data = testapp.get(rest_url + "/adhocracy/Documents/kommunismus/par1/LAST").json
    >>> resp_data['data']['adhocracy_core.sheets.tags.ITag']['elements']
    ['.../adhocracy/Documents/kommunismus/par1/VERSION_0000001/']
...
of a specific content type::
    ...
    >>> resp_data = testapp.get('/adhocracy/Documents/kommunismus',
    ...     params={'content_type': 'adhocracy_core.resources.document.IDocument'}).json
    >>> pprint(resp_data['data']['adhocracy_core.sheets.pool.IPool']['elements'])
    ['http://localhost/adhocracy/Documents/kommunismus/kapitel1/',
     'http://localhost/adhocracy/Documents/kommunismus/kapitel2/']
...
Or only children that implement a specific sheet::
    ...
    >>> pprint(resp_data['data']['adhocracy_core.sheets.pool.IPool']['elements'])
    ['http://localhost/adhocracy/Documents/kommunismus/FIRST/',
     'http://localhost/adhocracy/Documents/kommunismus/LAST/']
...
*all* can be used to get nested elements of arbitrary nesting depth::
    ...
    ...             'depth': 'all'}).json
    >>> pprint(resp_data['data']['adhocracy_core.sheets.pool.IPool']['elements'])
    [...'http://localhost/adhocracy/Documents/kommunismus/kapitel1/VERSION_0000001/'...]
...
their paths::
    ...
    >>> pprint(tag)
    {'content_type': 'adhocracy_core.interfaces.ITag',...'path': 'http://localhost/adhocracy/Documents/kommunismus/FIRST/'...
...
versions of all documents::
    ...
    >>> pprint(resp_data['data']['adhocracy_core.sheets.pool.IPool']['elements'])
    ['http://localhost/adhocracy/Documents/kommunismus/kapitel1/VERSION_0000001/',
     'http://localhost/adhocracy/Documents/kommunismus/kapitel2/VERSION_0000001/']
...
reference target. ::
    ...
    ...             'http://localhost/adhocracy/Documents/kommunismus/kapitel2/VERSION_0000000/',
    ...             'depth': 'all', 'tag': 'LAST'}).json
    >>> pprint(resp_data['data']['adhocracy_core.sheets.pool.IPool']['elements'])
    ['http://localhost/adhocracy/Documents/kommunismus/kapitel2/VERSION_0000001/']
