...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.box_url = "https://cms.liqd.net/intranet/technische-infrastruktur/public_files/vagrant-virtualbox-4_2_16-debian_wheezy_amd64.box/at_download/file"
